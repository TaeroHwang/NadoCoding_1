...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:\\Users\\MasterAwmp\\Desktop\\python.directory\\NadoCoding_1\\pygame_basic\\enemy.png")
enemy_size = enemy.get_rect().size # 이지미의 크기를 구해옴
enemy_width = enemy_size[0] # 캐릭터의 가로 크기
enemy_height = enemy_size[1] # 캐릭터의 세로 크기
enemy_x_pos = (screen_width / 2) - (enemy_width / 2)  # 화면 가로 크기의 절반에 해당하는 곳에 위치
