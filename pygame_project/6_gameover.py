...
# 화면 타이틀 설정
pygame.display.set_caption("Taero Pang") # 게임 이름
...
# weapon_height = weapon_size[1] : 높이는 필요없음?..
...
# 게임 종료 메시지 / TimeOut(시간 초과 실패), Mission Complete(미션 성공), Game Over(캐릭터 공에 맞음 실패)
